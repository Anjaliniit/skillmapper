...
public class EmailService {
	 ...
	 */
	public void createdEmployeeMessage(Employee employee,String message) {
		...
		try {
			...
			htmlMsg.append("<h1>Welcome " + employee.getFirstName() + " " + employee.getLastName() + " on SkillMapper!</h1>");
